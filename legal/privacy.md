...
| ------ | ------ | ------ | ------ |
| 필수정보 | 회원가입, 인증, 서비스 제공, 부정이용 확인 및 방지, 고객상담 | 성명 또는 법인명, 이메일, 비밀번호, 휴대폰 번호, 생년월일, 성별, 통신사명, 암호화된 이용자 확인값(CI), 중복가입확인정보(DI), 내/외국인정보 | 회원 탈퇴시 즉시 삭제 - 아이디인 이메일은 부정이용 이슈 방지를 위해 탈퇴 DB에서 6개월 후 삭제 - 휴대폰 번호는 부정이용(이벤트 혜택 중복 수취 등) 방지를 위해 복원 불가능한 암호화 값으로 변환하여 탈퇴 후 3년간 보관 - 구매 회원의 경우 5년간 보관 (전자상거래 등에서의 소비자보호에 관한 법률) - IP의 경우 3개월 보관 (통신비밀보호법) |
...
#### 5) 건강 데이터(Health Data) 수집 및 이용

**수집 항목**
- 심박수, 소모 칼로리 등 건강·피트니스 관련 데이터
  (기기 또는 Google Health Connect를 통해 제공되는 데이터)

**수집 목적**
- 요가 수업 기록과 함께 개인 건강 활동 이력을 저장·표시하기 위함

**동의 및 선택권**
- 건강 데이터 수집은 사용자의 **명시적 동의** 후에만 이루어집니다.
- 동의하지 않아도 앱의 기본 기능(수업 예약, 결제 등)을 사용할 수 있습니다.
- 동의 후 언제든지 앱 설정에서 권한을 철회할 수 있습니다.

**제3자 제공 및 공유**
- 건강 데이터는 광고, 마케팅, 제3자 판매 등의 목적으로 **절대 사용되지 않습니다.**
- 법령에 의한 경우를 제외하고 외부에 제공하지 않습니다.

**보관 및 삭제**
- 건강 데이터는 회원 탈퇴 시 즉시 삭제됩니다.
- 카카오 상담톡 통해 언제든지 삭제 요청할 수 있습니다.
